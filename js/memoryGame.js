	...
	function getActionComboBox(id) {
		$('#' + id).autocomplete({
	        ...
	        source: appConstants.getActionsList()
		        ...
		        // { value: "enlarging", label: "enlarging" },
