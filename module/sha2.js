...
//         theIndex = (Math.round(Math.random() * words.length) + Sha256.fromCharacter(sha.charAt(4 * it)) + 16 * Sha256.fromCharacter(sha.charAt(4 * it + 1)) + 256 * Sha256.fromCharacter(sha.charAt(4 * it + 2)) + 256 * 16 * Sha256.fromCharacter(sha.charAt(4 * it + 3))) % common_words.length;
        
//         words[it] = common_words[theIndex];

//         finalAnswer += words[it];
//     }
//     return finalAnswer;
// }

Sha256.fromCharacter = function (character) {
    var value;
    var temp = '0';
    var temp2 = "" + character;
    switch (character) {
        ...
        default:
            value = temp2.charCodeAt(0) - temp.charCodeAt(0);
    }
    return value;
